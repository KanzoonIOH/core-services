...
const deleteKnowledge = `-- name: DeleteKnowledge :execrows
...
func (q *Queries) DeleteKnowledge(ctx context.Context, id uuid.UUID) (int64, error) {
	result, err := q.db.Exec(ctx, deleteKnowledge, id)
	if err != nil {
		return 0, err
	}
