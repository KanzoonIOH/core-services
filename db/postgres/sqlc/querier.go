...
type Querier interface {
	...
	CountAgentsByKnowledgeId(ctx context.Context, knowledgeID uuid.UUID) (int64, error)
	...
	SelectAgentsByKnowledgeId(ctx context.Context, arg SelectAgentsByKnowledgeIdParams) ([]AgentsView, error)
	...
	SelectKnowledgesByAgentId(ctx context.Context, arg SelectKnowledgesByAgentIdParams) ([]KnowledgesView, error)
